...
description: "Full reference for every injectable Angular service: HTTP data services for species, battles, and statistics, plus shared UI services for alerts, theme, sidebar, and modals."
---
